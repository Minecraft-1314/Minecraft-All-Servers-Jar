...
4. 下载后按照常规流程配置服务器参数，即可启动使用
   4. After downloading, configure the server parameters according to the conventional process and start using it
...
- 微信支付：[(https://github.com/Minecraft-1314/Minecraft-All-Servers-Jar/qr_code.png)]]([https://github.com/yourusername/yourrepository/blob/main/alipay_qr_code.png](https://github.com/Minecraft-1314/Minecraft-All-Servers-Jar/qr_code.png)) | WeChat Pay: [(https://github.com/Minecraft-1314/Minecraft-All-Servers-Jar/qr_code.png)]]([https://github.com/yourusername/yourrepository/blob/main/alipay_qr_code.png](https://github.com/Minecraft-1314/Minecraft-All-Servers-Jar/qr_code.png))
